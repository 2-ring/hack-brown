...
export function Account() {
  ...
  // TODO: REMOVE - Always show settings popup for testing
  ...
  if (!user) {
    return (
      <>
        ...
        {/* TODO: REMOVE - Show settings popup for testing even when not signed in */}
        {isSettingsOpen && (
          <SettingsPopup
            onClose={() => setIsSettingsOpen(false)}
            userEmail="lucaskoverwolf@gmail.com"
            userName="Lucas"
